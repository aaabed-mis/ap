...
global.document={getElementById,querySelector:s=>makeEl(s),querySelectorAll:()=>[],documentElement:{setAttribute(){},style:{}},body:makeEl('body'),createElement:()=>({href:'',download:'',click(){}})};
...
const probe=`;(function(){
  console.log('Charts:', Chart.instances.map(c=>c.ctx.id).join(','));
